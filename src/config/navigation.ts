...
export const routes: RouteConfig[] = [
  ...
  { label: "Gumzo", path: "/smartphone/messages", icon: MessageSquare, roles: ["client", "worker", "admin"], mobile: true },
  { label: "Baraza", path: "/smartphone/community", icon: Users2, roles: ["client", "worker", "admin"], mobile: true },
  { label: "Profile", path: "/smartphone/profile", icon: User, roles: ["client", "worker", "admin"], mobile: false },
